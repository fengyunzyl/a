...
r8=(ffmpeg -i %q -c copy -movflags faststart -f mp4 %q.m4a)
r9=(ffmpeg -i %q -c copy -vn -movflags faststart -metadata title=%q
  -f mp4 %q.m4a)
r10=(ffmpeg -i %q -b:a 256k -movflags faststart -f mp4 %q.m4a)
