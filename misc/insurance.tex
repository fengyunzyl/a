...
\xr 12
\newdimen\ya
\ya \dimexpr .5\textwidth - 2\tabcolsep
\loop \ifnum\xr > 0
...
or if a police officer asks to see it. \bigskip
...
\begin{center}
\bf Tarjeta de Seguro de \\
Responsabilidad de Texas \bigskip
...
tiene un accidente o si un oficial de la paz se la pide. \bigskip
